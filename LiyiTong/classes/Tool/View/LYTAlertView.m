...
- (void)basicInit {
    ...
    _bottomMargin = 25;
    _leftRightMargin = 34;
    _leftRightPadding = 235;
    _msgTextFont = [UIFont systemFontOfSize:16];
    _actionButtonsFont = [UIFont systemFontOfSize:17];
    _characterSpacing = 0;
    _lineSpacing = 5;
...
- (UIView *)mainAlertView {
    if (!_mainAlertView) {
        CGFloat width = ScreenWidth - 2*_leftRightPadding;
...
- (void)setLeftRightPadding:(CGFloat)leftRightPadding {
    if (leftRightPadding != _leftRightPadding) {
        ...
        CGFloat mainAlertWidth = ScreenWidth - 2*_leftRightPadding;
        CGRect frame = self.mainAlertView.frame;
