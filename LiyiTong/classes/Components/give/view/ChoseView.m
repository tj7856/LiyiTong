...
@synthesize alphaiView,whiteView,img,lb_detail,lb_price,lb_stock,mainscrollview,sizeView,colorView,bt_sure,bt_cancle,lb_line;
   ...
   self = [super initWithFrame:frame];
    if (self) {
       ...
       //装载商品信息的视图
        ...
        lb_price.textColor = Color(0, 240, 200);
