...
//        LYTtarBTN *view = [[LYTtarBTN alloc] initWithFrame:CGRectMake(itemWidth * i+itemWidth/2-2, SELF_HEIGHT/2-2, 4, 4)];
//        LYTtarBTN *view = [[LYTtarBTN alloc]init]
        if (i==0) {
            LYTtarBTN *view = [[LYTtarBTN alloc] initWithFrame:CGRectMake(-12, -20, itemWidth, itemWidth)];
             [self.colorfulView addSubview:view];
        }
        else if (i==3)
        {
            LYTtarBTN *view = [[LYTtarBTN alloc] initWithFrame:CGRectMake(itemWidth * i+12, -20, itemWidth, itemWidth)];
             [self.colorfulView addSubview:view];
        }
        else
        {
        LYTtarBTN *view = [[LYTtarBTN alloc] initWithFrame:CGRectMake(itemWidth * i+13, -7, itemWidth-26, itemWidth-26)];
             [self.colorfulView addSubview:view];
        }
